...
//자료형(Data Type)
// 자료형의 종류
// 1. 원시형 자료 (Primary Type) : 특정 값이 메모리에 저장(값만)
// -문자형([Object String]) Slice(8,-1)
// -숫자형(Number)
// -논리형(Boolean : true, false)
// -undefined : 변수를 선언하고 그 값을 초기화 하지 않으면 undefined 저장됨(에러 원인되니까..)
...
// - 객체 - {} : Object 데이터를 key라는 인덱싱을 통해 자료를 구조적으로 묶어 놓은 상태 
